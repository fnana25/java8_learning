...
public class Loader11 extends ClassLoader{
    ...
    public static void test(ClassLoader classLoader) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        Class<?> clazz = classLoader.loadClass("com.test.jvm.classloader.Loader1");
...
//        test(loader1);
        ...
        Loader11 loader1 = new Loader11("loader1");
        loader1.setPath("D:\\");
        Class<?> clazz1 = loader1.loadClass("com.test.jvm.classloader.Loader1");
        Object object1 = clazz1.newInstance();
        System.out.println(object1);

        Loader11 loader2 = new Loader11("loader2");
        loader1.setPath("D:\\");
        Class<?> clazz2 = loader1.loadClass("com.test.jvm.classloader.Loader1");
